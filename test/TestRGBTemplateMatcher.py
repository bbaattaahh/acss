...
class TestRGBTemplateMatcher(unittest.TestCase):
    def test_rectangle_top_left_vertices_working(self):
        ...
        threshold = 2.3
        rgb_template_matching = RGBTemplateMatcher(rgb_template=rgb_template,
                                                   threshold=threshold)
        ...
        # when
        actual_rectangle_top_left_vertices = rgb_template_matching.rectangle_top_left_vertices(rgb_image)
    ...
    def test_tuple_numpy_array_to_list_working(self):
        ...
        # when
        actual_list = RGBTemplateMatcher.tuple_numpy_array_to_list(tuple_numpy_array)
    ...
    def test_numerical_derivation_position_correction_working(self):
        ...
        # when
        actual_corrected_positions = RGBTemplateMatcher.numerical_derivation_position_correction(positions)
