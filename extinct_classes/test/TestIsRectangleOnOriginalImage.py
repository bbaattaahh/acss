...
class TestIsRectangleOnOriginalImage(unittest.TestCase):
    ...
    def test_calculate_original_coordinate_before_rotation__45_rotation(self):
        ...
        angle = 45
        vertex = [0, 0]
        expected_original_vertex = [160, -160]
        ...
        # that
        self.assertAlmostEqual(actual_original_vertex[0], expected_original_vertex[0], delta=0.001)
        self.assertAlmostEqual(actual_original_vertex[1], expected_original_vertex[1], delta=0.001)
